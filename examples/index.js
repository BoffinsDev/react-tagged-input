...
/***/ function(module, exports, __webpack_require__) {
	...
	React.render(React.createElement(Test, null), mountPoint);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Non removable tags.
	var StaticTagComponent = React.createClass({displayName: "StaticTagComponent",
	  render: function () {
	    var self = this, p = self.props;

	    return (
	      React.createElement("div", {className: joinClasses("tag", 'static-tag', p.classes)}, 
	        React.createElement("div", {className: "tag-text"}, p.item)
	  ...
	  render: function () {
	    ...
	    for (var i = 0; i < s.statics.length; i++) {
	      tagStaticComponents.push(
	        React.createElement(StaticTagComponent, {
	          item: s.statics[i], 
	          key: s.statics[i], 
	          itemIndex: i, 
	    ...
	    for (var i = 0; i < s.tags.length; i++) {
	      tagComponents.push(
	        React.createElement(DefaultTagComponent, {
	          item: s.tags[i], 
	          key: s.tags[i], 
	          itemIndex: i, 
	          onRemove: self._handleRemoveTag.bind(this, i), 
